...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      // jika alert = 1
      // tampilkan pesan Sukses "Kategori baru berhasil disimpan"
      elseif ($_GET['alert'] == 1) {
      ...
      // jika alert = 2
      // tampilkan pesan Sukses "Kategori berhasil diubah"
      elseif ($_GET['alert'] == 2) {
        echo "<div class='alert alert-success alert-dismissable'>
              <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
              <h4>  <i class='icon fa fa-check-circle'></i> Sukses!</h4>
      ...
      // jika alert = 3
      // tampilkan pesan Sukses "Kategori berhasil dihapus"
      elseif ($_GET['alert'] == 3) {
        echo "<div class='alert alert-success alert-dismissable'>
              <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
              <h4>  <i class='icon fa fa-check-circle'></i> Sukses!</h4>
              ...
              <tbody>
                ...
                while ($data = mysqli_fetch_assoc($query)) {
                  ...
                  echo "<tr>
                      ...
                      <td width='350'>$data[nama_kategori]</td>
