...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act'] == 'insert') {
        if (isset($_POST['simpan'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO kategori(nama_kategori,created_user,updated_user) 
                                            VALUES('$nama_kategori','$created_user','$created_user')")
        ...
        if (isset($_POST['simpan'])) {
            if (isset($_POST['id_kategori'])) {
                ...
                $query = mysqli_query($mysqli, "UPDATE kategori SET nama_kategori    = '$nama_kategori',
