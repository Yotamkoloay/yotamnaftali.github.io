...
<section class="content-header">
  <h1>
    <i class="fa fa-file-text-o icon-title"></i> Laporan Stok Bagan
      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <div>
            ...
            <span style="color:#337ab7" class="label label-primary">``</span> = Stok Habis <br>
            <div>
              <span style="color:#f0ad4e" class="label label-warning">``</span> = Stok Kurang
            </div>
          </div>
        </div><!-- /.box-body -->
      </div><!-- /.box -->
