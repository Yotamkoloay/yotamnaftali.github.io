...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT a.id_keluar,a.tanggal_keluar,sum(a.harga),a.id_tangkapan,sum(a.jumlah_keluar),a.created_user,a.status,b.id_jenis,b.id_tangkapan,b.nama_tangkapan,b.id_satuan,b.created_user,c.id_satuan,c.nama_satuan,d.username,d.id_user,e.id_jenis,e.nama_jenis
                                    ...
                                    WHERE   a.tanggal_keluar BETWEEN '$tgl_awal' AND '$tgl_akhir' AND a.status='Approve'
            ...
            <tbody>
                ...
                // jika data tidak ada
                    ...
                    while ($data = mysqli_fetch_assoc($query)) {
                        ...
                        <td style='padding-left:5px;' width='100' height='13' align='center' valign='middle'>$pembulatan $data[nama_satuan]</td>
                        <td style='padding-left:5px;' width='100' height='13' align='center' valign='middle'>Rp.$harga</td>
                    </tr>";
                        $no++;
                    }
                }
