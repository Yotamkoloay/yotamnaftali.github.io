...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT a.id_keluar,a.tanggal_keluar,a.harga,a.id_tangkapan,a.jumlah_keluar,a.created_user,a.status,b.id_jenis,b.id_tangkapan,b.nama_tangkapan,b.id_satuan,b.created_user,c.id_satuan,c.nama_satuan,d.username,d.tempat,d.id_user,e.id_jenis,e.nama_jenis
                                    FROM keluar as a INNER JOIN tangkapan as b INNER JOIN satuan as c INNER JOIN users as d Inner join jenis_tangkapan as e
                                    ON a.id_tangkapan=b.id_tangkapan AND b.id_satuan=c.id_satuan AND b.id_jenis=e.id_jenis WHERE d.id_user='$_SESSION[id_user]' AND a.created_user=d.id_user AND a.tanggal_keluar BETWEEN '$tgl_awal' AND '$tgl_akhir' AND a.status='Approve'
