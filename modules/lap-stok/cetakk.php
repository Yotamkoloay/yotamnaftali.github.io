...
$query = mysqli_query($mysqli, "SELECT a.id_tangkapan,a.nama_tangkapan,a.id_jenis,a.id_satuan,a.stok,b.id_jenis,b.nama_jenis,c.id_satuan,c.nama_satuan 
                                ...
                                ON a.id_jenis=b.id_jenis AND a.id_satuan=c.id_satuan WHERE a.stok >= 1 and a.stok <=10 ORDER BY id_tangkapan DESC")
...
<?php
$filename = "LAPORAN STOK KURANG.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
