...
$query = mysqli_query($mysqli, "SELECT a.id_tangkapan,a.nama_tangkapan,a.id_jenis,a.id_satuan,a.stok,b.id_jenis,b.nama_jenis,c.id_satuan,c.nama_satuan 
                                ...
                                ON a.id_jenis=b.id_jenis AND a.id_satuan=c.id_satuan WHERE stok <= 0 ORDER BY id_tangkapan DESC")
...
<head>
    ...
    <title>LAPORAN STOK HABIS</title>
            ...
            <tbody>
                ...
                while ($data = mysqli_fetch_assoc($query)) {
                    ...
                    echo "  <tr>
                        ...
                        <td style='padding-left:5px;' width='215' height='13' align='center'>$data[nama_tangkapan]</td>
                        <td style='padding-left:5px;' width='150' height='13' align='center'>$data[nama_jenis]</td>
                        <td style='padding-right:10px;' width='80' height='13' align='center'>$data[stok]</td>
                        <td style='padding-left:5px;' width='80' height='13' align='center'>$data[nama_satuan]</td>
                    </tr>";
                    $no++;
                }
                ?>
...
<?php
$filename = "LAPORAN STOK HABIS.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
