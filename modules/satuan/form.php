...
if ($_GET['form'] == 'add') { ?>
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Input Satuan Tangkapan
    </h1>
    <ol class="breadcrumb">
...
elseif ($_GET['form'] == 'edit') {
  if (isset($_GET['id'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT * FROM satuan WHERE id_satuan='$_GET[id]'")
      or die('Ada kesalahan pada query tampil Data Satuan Tangkapan : ' . mysqli_error($mysqli));
...
?>
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Ubah Satuan
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=home"><i class="fa fa-home"></i> Beranda </a></li>
      <li><a href="?module=satuan"> Satuan </a></li>
