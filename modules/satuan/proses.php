...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO satuan(nama_satuan,created_user,updated_user) 
    ...
    elseif ($_GET['act']=='update') {
        if (isset($_POST['simpan'])) {
            if (isset($_POST['id_satuan'])) {
                ...
                $query = mysqli_query($mysqli, "UPDATE satuan SET nama_satuan    = '$nama_satuan',
    ...
    elseif ($_GET['act']=='delete') {
        if (isset($_GET['id'])) {
            ...
            $query = mysqli_query($mysqli, "DELETE FROM satuan WHERE id_satuan='$id_satuan'")
