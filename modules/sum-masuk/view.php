...
<section class="content-header">
  <h1>
    <i class="fa fa-file-text-o icon-title"></i> Laporan Total Pemasukan
  </h1>
  <br>
  <ol class="breadcrumb">
    <hr>
    ...
    <li class="active">Total Pemasukan </li>
  </ol>
</section>
<br>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <!-- form start -->
        <form role="form" class="form-horizontal" method="GET" action="modules/sum-masuk/cetak.php" target="_blank">
          <div class="box-body">
